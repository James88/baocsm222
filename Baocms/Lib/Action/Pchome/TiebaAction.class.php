...
class TiebaAction extends CommonAction {
    ...
    public function zan() {
        ...
        $this->baoSuccess('恭喜您，点赞成功！', U('tieba/detail', array('post_id' => $post_id)));
    }
    ...
    public function zans() {
        ...
        $this->baoSuccess('恭喜您，点赞成功！', U('tieba/detail', array('post_id' => $detail['post_id'])));
    }
    ...
    public function reply($post_id) {
        ...
        if ($this->isPost()) {
            ...
            if ($obj->add($data)) {
                ...
                $this->baoSuccess('回复成功', U('tieba/detail', array('post_id' => $post_id)));
            }
            $this->baoError('操作失败！');
        } else {
            $this->assign('detail', $detail);
    ...
    public function post() {
        ...
        if ($this->isPost()) {
            ...
            if ($obj->add($data)) {
                ...
                $this->baoSuccess('恭喜您，发帖成功！', U('tieba/index'));
            }
            $this->baoError('操作失败！');
        } else {
            $this->baoError('不支持该操作！');
        }
    }
