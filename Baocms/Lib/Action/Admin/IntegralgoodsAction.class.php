...
class IntegralgoodsAction extends CommonAction {
    ...
    private $create_fields = array('title', 'face_pic', 'shop_id','integral', 'price', 'num', 'limit_num', 'exchange_num', 'details', 'orderby', 'create_time', 'create_ip');
    private $edit_fields = array('title', 'face_pic','shop_id', 'integral', 'price', 'num', 'limit_num', 'exchange_num', 'details', 'orderby', 'create_time', 'create_ip');
    ...
    public function index() {
        ...
        if ($shop_id = (int) $this->_param('shop_id')) {
            $map['shop_id'] = $shop_id;//查询商家
            $shop = D('Shop')->find($shop_id);
            $this->assign('shop_name', $shop['shop_name']);//赋值名字
            $this->assign('shop_id', $shop_id);
        }
        if ($audit = (int) $this->_param('audit')) {//审核状态
