...
class ShopAction extends CommonAction {
    ...
    private $create_fields = array('user_id', 'cate_id','city_id', 'area_id', 'business_id', 'shop_name', 'logo', 'mobile', 'photo', 'addr', 'tel', 'extension', 'contact', 'tags', 'near', 'is_pei', 'business_time', 'orderby', 'lng', 'lat', 'price');
    private $edit_fields = array('user_id', 'cate_id','city_id', 'area_id', 'business_id', 'shop_name', 'mobile', 'logo', 'photo', 'addr', 'tel', 'extension', 'contact', 'tags', 'near', 'business_time', 'is_pei', 'orderby', 'lng', 'lat', 'price','is_ding');
